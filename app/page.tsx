...
import { articles, ads } from "@/lib/data";
        ...
        <div className="max-w-md mx-auto px-5 h-14 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <Link href="/chat" className="w-8 h-8 rounded-full border border-[#C9A96E]/30 flex items-center justify-center">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#C9A96E" strokeWidth="1.5"><path d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z"/></svg>
            </Link>
          </div>
        </div>
      </header>
      ...
      <div className="pt-14 max-w-md mx-auto">
        ...
        <section className="px-5 mt-10">
          <div className="relative h-[200px] rounded-xl overflow-hidden">
            <Image src="/images/art-gallery.jpg" alt="Art Gallery" fill className="object-cover" />
            ...
            <button onClick={() => router.push("/explore")} className="absolute top-4 right-4 w-8 h-8 rounded-full bg-[#0A0A0A]/40 backdrop-blur-sm flex items-center justify-center border border-[#F2EDE4]/20">
        ...
        <div className="fixed inset-0 z-50 bg-[#0A0A0A]/95 flex items-center justify-center p-5" onClick={() => setShowVideoModal(false)}>
          <div className="w-full max-w-md text-center">
            <div className="w-16 h-16 rounded-full bg-[#C9A96E]/20 flex items-center justify-center mx-auto mb-4">
              <svg width="32" height="32" viewBox="0 0 24 24" fill="#C9A96E"><path d="M8 5v14l11-7z"/></svg>
            </div>
            <h3 className="text-xl font-serif mb-2">Video Coming Soon</h3>
            <p className="text-sm text-[#F2EDE4]/60 mb-6">This video story is being produced. Check back shortly.</p>
            <button onClick={() => setShowVideoModal(false)} className="bg-[#C9A96E] text-[#0A0A0A] text-xs font-bold tracking-wider uppercase px-6 py-3 rounded-full">
              Continue Reading
            </button>
          </div>
        </div>
